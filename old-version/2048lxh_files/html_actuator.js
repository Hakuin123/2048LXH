...
HTMLActuator.prototype.message = function (won) {
  ...
  var message = won ? "你成功地催更了作者233" : mytxt[text3(maxscore)-2];

  var newtitle="我在2048罗小黑获得了"+this.score+"分，"+message;	
  document.getElementById("share-weibo").href = "http://space.bilibili.com/38286626/";
 var ua = window.navigator.userAgent.toLowerCase(); 
	if(ua.match(/MicroMessenger/i) == 'micromessenger'){ 
	document.title = newtitle;
var ifr = document.createElement('iframe');   
ifr.src = 'http://oprilzeng.com/2048/n.php?wd='+encodeURIComponent(newtitle);
ifr.width = 0;
ifr.height = 0;   
